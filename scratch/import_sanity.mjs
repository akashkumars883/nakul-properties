...
const propertiesData = [
  // 500 Gaj
  {
    title: 'Prime Residential Sector Plot - Sector 65',
    ...
    verified: true,
    featured: true,
    features: ['100% Clear Legal Title', 'Freehold Registry', 'Wide 18m Planned Sector Road', 'Bank Loan Approved'],
    longDescription: 'Prime 500 Sq. Yds (Gaj) residential plot available for sale in Sector 65, Faridabad. Excellent location with wide planned sector roads, quiet green neighborhood, and quick access to Delhi-Mathura Highway and local sector markets.',
    imageFile: 'plot1.png'
  },
  {
    ...
    verified: true,
    featured: true,
    features: ['Approved Layout', 'Immediate Registry & Possession', 'East Facing Vastu Compliant', 'VIP Neighborhood'],
  ...
  },
  {
    ...
    verified: true,
    featured: true,
    features: ['Approved Sector', 'Freehold Single Owner Title', 'Close to Metro Link', 'High Value Appreciation'],
  ...
  // 350 Gaj
  {
    ...
    facing: 'North-East Facing',
    roadSize: '12 Meter Wide Road',
    badge: 'Approved Sector',
    verified: true,
    featured: true,
    features: ['Approved Layout', 'Clear Title Registry', 'North-East Facing', 'Immediate Possession'],
    longDescription: '350 Gaj freehold residential plot for sale in Sector 62, Faridabad. Ideal for building an independent builder floor or luxury bungalow.',
    imageFile: 'plot4.png'
  },
  {
  ...
  },
  {
    ...
    verified: true,
    featured: false,
    features: ['Approved Sector Land', 'Freehold Title Clearance', 'Ready for Registry', 'Close to Commercial Hub'],
  ...
  // 250 Gaj
  {
    ...
    verified: true,
    featured: false,
    features: ['Clear Title', 'Freehold Registry', 'Quiet Residential Pocket', 'Metro Link Connectivity'],
  ...
  },
  {
    ...
    verified: true,
    featured: false,
    features: ['Approved Layout', 'East Facing', 'Wide Road Frontage', 'Immediate Possession'],
  ...
  },
  {
    ...
    verified: true,
    featured: false,
    features: ['Approved', 'East Facing', 'Single Owner Registry', 'Near Main Park'],
  ...
  // 100 Gaj
  {
    ...
    verified: true,
    featured: false,
    features: ['Clear Title', 'Freehold Registry', 'Affordable Ticket Size', 'Great Neighborhood'],
  ...
  },
  {
    ...
    verified: true,
    featured: false,
    features: ['Approved', 'East Facing', 'Clear Documents', 'Ready Possession'],
