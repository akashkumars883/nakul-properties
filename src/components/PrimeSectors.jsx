  ...
  const sectors = [
    {
      ...
      plotsCount: '8+ Properties Available',
      highlights: '100 to 500 Gaj Freehold Plots & Floors, 18m Wide Sector Roads',
    ...
    },
    {
      id: 'sector-64',
      name: 'Sector 64',
      type: 'Prime Residential Sector',
      icon: Building,
      price: 'Starting ₹1.60 Cr*',
      plotsCount: '6+ Properties Available',
    ...
    },
    {
      id: 'sector-63',
      name: 'Sector 63',
      type: 'Residential & Commercial Sector',
      icon: Store,
      price: 'Starting ₹1.45 Cr*',
      plotsCount: '5+ Properties Available',
      highlights: 'Freehold Plots, Floors & Commercial Spaces',
      image: '/plot4.png',
      link: '/locations/sector-63',
    },
    {
      id: 'sector-62',
      name: 'Sector 62',
      ...
      plotsCount: '7+ Properties Available',
    ...
    },
    {
      id: 'sector-2',
      name: 'Sector 2',
      type: 'Prime Location & Connectivity',
      icon: LandPlot,
      price: 'Starting ₹1.35 Cr*',
      plotsCount: '5+ Properties Available',
      highlights: 'Verified Residential Plots, Builder Floors & Flats',
      image: '/plot2.png',
      link: '/locations/sector-2',
    },
  ];
